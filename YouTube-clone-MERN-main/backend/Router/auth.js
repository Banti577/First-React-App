...
auth.post("/signup", async (req, res) => {
  try {
    ...
    const mailOptions = {
      ...
      to: email,
      subject: "Welcome to SwipNest!",
      html: `
        <div style="font-family: Arial, sans-serif; background-color: #f5f5f5; padding: 20px;">
          <h1 style="color: #333;">Welcome to SwipNest!</h1>
          ...
          <p style="color: #555;"> Banti Patel</p>
        </div>
      `,
    };
...
auth.post("/resetlink", async (req, res) => {
  try {
    ...
    console.log('BACKEND_URL value is', BACKEND_URL)
    ...
    const mailOptions = {
      ...
      html: `
        <div style="font-family: Arial, sans-serif; background-color: #f5f5f5; padding: 20px;">
          ...
          <p style="color: #888;">Best regards,<br/>Banti Patel</p>
        </div>
      `,
    };
